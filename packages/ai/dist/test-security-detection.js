 ...
 */
import { SecurityThreatDetectionSystem, RealTimeThreatMonitor } from './security-threat-detection';
/**
 ...
 */
function generateMaliciousEvents() {
...
async function testPerformanceMetrics() {
    ...
    console.log(`  Threat distribution: ${JSON.stringify(threatLevels.reduce((acc, level) => {
