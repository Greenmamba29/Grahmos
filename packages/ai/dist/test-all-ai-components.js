...
import { VectorSearchService, DocumentProcessingPipeline, PredictiveAnalyticsEngine, NLPQueryProcessor } from './index';
/**
 ...
 */
async function testNLPQueryProcessing() {
...
async function testAIIntegration() {
    ...
    try {
        ...
        await vectorSearch.indexDocument(processedDoc.id, processedDoc.content, {
        ...
        const searchFunction = async (structuredQuery) => {
            const searchResults = await vectorSearch.search(structuredQuery.parameters.query || 'emergency', { limit: 5 });
        ...
        const queryResponse = await nlpProcessor.processQuery('Find emergency evacuation procedures for buildings', 'integration_test_session', 'test_user', searchFunction);
