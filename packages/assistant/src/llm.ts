 ...
 */
export async function chat(messages: ChatMessage[], options: LLMOptions = {}): Promise<LLMResponse> {
 ...
 */
async function gemma3nChat(messages: ChatMessage[], options: LLMOptions = {}): Promise<LLMResponse> {
 ...
 */
async function openaiChat(messages: ChatMessage[], options: LLMOptions = {}): Promise<LLMResponse> {
 ...
 */
export async function simpleChat(prompt: string, options: LLMOptions = {}): Promise<string> {
 ...
 */
export async function systemChat(systemPrompt: string, userPrompt: string, options: LLMOptions = {}): Promise<string> {
  const messages: ChatMessage[] = [
